...
const HomeHero = () => {
  return (
    <div className="home__hero_data">
      <h1 className="home__hero_title">{heroContent.name}</h1>
      <h3 className="home__hero_subtitle">{heroContent.title}</h3>
      <p className="home__hero_description">{heroContent.description}</p>
